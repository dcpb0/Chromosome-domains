...
Interactoin matrix are stored under interaction_matrices folder. Here we provide the interaction matrices for free polymer, uniformly attractive polymer, single domain polymers with 3X, 10X and 100X interaction inside and outside of the domain and polymer with two domains that are 1,5 and 9 regions away from each other, DIMES matrices for WT, H3K9me-, Condensin- dataset.
